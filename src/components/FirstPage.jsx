    ...
    return (
        <div className="firstPage">
            <div className="leftSide">
                ...
                <div className="groups">
                    {groups.map((group, index) => {
                        ...
                        if (a.length === 1) {
                            initials = a[0].charAt(0).toUpperCase() + (a[0].length > 1 ? a[0].charAt(1).toUpperCase() : "");
                        } else if (a.length === 2) {
                            initials = a[0].charAt(0).toUpperCase() + a[1].charAt(0).toUpperCase();
                        }

                        return (
                            <div className="group" key={index} onClick={handleGroupChats}>
                                <div className="logo" style={{ width: "50px", height: "50px", borderRadius: "50%", backgroundColor: group.color, color: "white" }}>{initials}</div>
            ...
            <div className="rightSide">
                <img src={rectangle} alt="rectanlge" className="rectangle" />
                <img src={firstPage_img} alt="firstPage image" className="firstPageImg" />
          ...
          <GroupChats handleGroupChats={handleGroupChats} />
